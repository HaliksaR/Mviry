...
private fun createReducer(): Reducer<State, Modification> =
    { _: State, modification: Modification ->
        when (modification) {
...
private fun ExampleManyStoreFragment.getStore() =
    object : MviryStore<State, Action, Modification, SideEffect> {
...
private fun getView() =
    object : MviryRenderView<State, Action, SideEffect> {
